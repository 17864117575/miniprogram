...
Page({
  data: {
    ...
    UI: [{
        ...
        bind: "更改个人信息",
        unbind: "解除绑定",
        unbindMsgTitle: "解除账户绑定",
        unbindMsgContent: "我已知晓解除与COMPANY账户的绑定后，将导致部分功能不可用。"
      },
      {
        title: "Settings",
        ...
        bind: "Bind with COMPANY ID",
        unbind: "Unbind COMPANY ID",
        unbindMsgTitle: "Unbind Account",
        unbindMsgContent: "I am aware unbinding COMPANY ID will cause some features to be unavailable."
      },
      {
        title: "設定",
        language: "言語変更",
